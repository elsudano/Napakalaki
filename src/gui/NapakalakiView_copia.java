...
public class NapakalakiView_copia extends javax.swing.JFrame {
    ...
    private class TreasureView extends JPanel {
        ...
        TreasureView(Treasure unTesoro) {
            ...
            jL_bonus.setText("+" + treasure.getBasicValue() + "/+" + treasure.getSpecialValue());
