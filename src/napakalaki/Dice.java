...
/**
 * Clase Dado, tiene parte gráfica se encarga de reproducir los numeros de un
 * dado que servira para realizar las tiradas del juego.
 *
...
public class Dice extends javax.swing.JDialog {
    ...
    /**
     * Creador de la unica instancia del dado en el Juego.
     *
     * @return devuelve la unica instancia del dado.
     */
    ...
    /**
     * Método auxiliar que devuelve el siguiente valor entre 1 y 6 simulando que
     * es un dado
     *
    ...
    /**
     * Método que devuelve el siguiente valor entre 1 y 6 simulando que es un
     * dado
     *
     * @return devuelve un numero entero entre 1 y 6
     */
    ...
    /**
     * Método que devuelve el siguiente valor entre 1 y 6 simulando que es un
     * dado, pero en este caso podemos indicarle cuales son los mensajes que
     * vamos a poner en la ventana del dado.
     *
     * @param message1
     * @param message2
     * @return
