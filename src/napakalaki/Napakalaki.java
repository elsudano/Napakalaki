...
/**
 * Clase principal del juego, contiene las instancias principales
 * para el desarrollo de una partida.
 * @authors:
...
public class Napakalaki {
    ...
    /**
     * Consultor que se encarga de devolver el 
    ...
    /**
     * Metodo auxiliar que sirve para inicializar los jugadores
     * basicamente añade los nombres a un array
    ...
    /**
     * Metodo auxiliar que devuelve el siguiente jugador que 
     * le toca participar en el juego
    ...
    /**
     * Metodo auxiliar que sirve para decir si un jugador tiene el turno
     * de tirada de dado permitida
    ...
    /**
     * Con esto pedimos una instancia unica del juego para poder
     * interactuar con la parte de la interfaz gráfica.
    ...
    /**
     * Metodo que se encarga de realizar los combates
     * entre juegadores y monstruos
     * @return devuelve un objeto de tipo CombarResult
     * con el resultado del combate
     */
    ...
    /**
     * Metodo publico que sirve para descartar todo los 
     * tesoros visibles que se pasan por parametros en el array
    ...
    /**
     * Metodo publico que sirve para descartar todo los 
     * tesoros ocultos que se pasan por parametros en el array
     * @param treasures array de tipo tesoro que serán los que se descartan
     */
    ...
    /**
     * Metodo que se encarga de cambiar los tesoros de la lista 
     * de los tesoros ocultos a tesoros visibles
     * @param treasures lista de tesoros validos que se puedan poner como visibles
     */
    ...
    /**
     * Metodo que se encarga de inicializar todas las variables
    ...
    /**
     * Consultor del tipo de circunstancia que se lleva a cabo
     ...
     * @return devuelve verdadero si el juego ha llegado a su fin
     * falso en su caso contrario.
     */
